...
from app.tool.lxy_analyze_resume_database_for_recruitment_v2 import LxyAnalyzeResumeDatabaseForRecruitmentV2
...
class LxyManus_v1_1(ToolCallAgent):
    ...
    available_tools: ToolCollection = Field(
        default_factory=lambda: ToolCollection(
            LxyAnalyzeResumeDatabaseForRecruitmentV2(),Terminate()
        )
    )
